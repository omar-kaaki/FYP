...
echo ""
echo "4. Test Hot Blockchain setup (active investigation chain):"
echo "   ${BLUE}cd ~/FYPBcoc/hot-blockchain${NC}"
echo "   ${BLUE}./scripts/test-ca-setup.sh --skip-crypto${NC}"
echo ""
echo "5. Test Cold Blockchain setup (archival chain):"
echo "   ${BLUE}cd ~/FYPBcoc/cold-blockchain${NC}"
echo "   ${BLUE}./scripts/test-ca-setup.sh --skip-crypto${NC}"
echo ""
echo "6. Check the requirements.md file for additional information"
echo ""
