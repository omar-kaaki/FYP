#!/bin/bash
#
# stop-network.sh - Stop COLD blockchain network
#
...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}  COLD Blockchain Network Shutdown${NC}"
echo -e "${BLUE}========================================${NC}"
echo ""
...
# Stop network
cd "${BASE_DIR}"
print_info "Stopping COLD blockchain network..."
...
echo ""
echo -e "${GREEN}COLD blockchain network shutdown complete${NC}"
echo ""
